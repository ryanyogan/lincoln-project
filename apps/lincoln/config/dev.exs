...
config :lincoln, LincolnWeb.Endpoint,
  ...
  code_reloader: true,
  debug_errors: true,
  secret_key_base: "KKxjoVw/fhghOffyqxbuKG9i/5HWv4Gl+IQYbzYUGSGUDau7EauhtzWbOerofEUl",
  watchers: [
    esbuild: {Esbuild, :install_and_run, [:lincoln, ~w(--sourcemap=inline --watch)]},
    tailwind: {Tailwind, :install_and_run, [:lincoln, ~w(--watch)]}
  ]
...
config :lincoln, LincolnWeb.Endpoint,
  live_reload: [
    ...
    patterns: [
      ...
      ~r"lib/lincoln_web/router\.ex$",
      ~r"lib/lincoln_web/(controllers|live|components)/.*\.(ex|heex)$"
    ]
  ]

# Enable dev routes for dashboard and mailbox
config :lincoln, dev_routes: true
